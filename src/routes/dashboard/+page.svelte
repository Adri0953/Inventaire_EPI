...
>
      ...
      >
        ...
        <div class="flex">
          ...
          {#if alerts.lowStock.length > 0}
            ...
            <div
              class="w-64 shrink-0 border-l-2 border-amber-100 bg-amber-50/40 flex flex-col items-center justify-center gap-5 p-6"
            >
              <div class="relative">
                <svg
                  width="160"
              ...
              <div class="flex flex-col gap-2 w-full">
                <div class="flex items-center justify-between">
                  ...
                  <span class="text-lg font-black text-slate-800">{nbRuptures}</span>
                </div>
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-2">
                  ...
                  <span class="text-lg font-black text-slate-800">{nbCritiques}</span>
                </div>
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-2">
                  ...
                  <span class="text-lg font-black text-slate-800">{nbBas}</span>
                </div>
              </div>
            </div>
          {/if}
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
    <!-- Inventaire total -->
    <div
      class="lg:col-span-2 relative rounded-3xl p-6 overflow-hidden shadow-xl flex flex-col justify-between bg-linear-to-r from-blue-950 to-blue-700"
    >
      <Package class="absolute -right-4 -bottom-4 w-32 h-32 text-white/5 opacity-10" />
      <div class="relative z-10">
        <p class="text-blue-200 font-black uppercase tracking-widest text-[10px]">
          Inventaire Total
        </p>
    ...
    <!-- Taux d'attribution -->
    <div
      class="relative rounded-3xl p-6 shadow-xl flex flex-col justify-between overflow-hidden bg-linear-to-r from-blue-700 to-blue-400"
    >
      <Activity class="absolute -right-3 -top-3 w-24 h-24 text-white/10" />
      <div class="relative z-10">
        <p class="text-cyan-100 font-black uppercase tracking-widest text-[10px]">Équipements</p>
        <div class="flex items-end gap-1 mt-1">
          <span class="text-5xl font-black text-white tabular-nums leading-none tracking-tighter"
            >{tauxAttribution}</span
          >
          <span class="text-2xl font-black text-cyan-100 mb-0.5">%</span>
        </div>
        <p class="text-cyan-100 text-xs font-bold uppercase tracking-widest mt-1">
          Taux d'attribution
        </p>
      </div>
      <div class="relative z-10 mt-4">
        <div class="h-2 bg-white/20 rounded-full overflow-hidden border border-white/20">
          <div
        ...
        <div class="flex justify-between mt-1.5">
          <span class="text-[10px] text-cyan-100 font-bold">{stats.attribues} attribués</span>
          <span class="text-[10px] text-cyan-100 font-bold">{stats.total} total</span>
        </div>
      </div>
    </div>
    ...
    <!-- Chauffeurs sans EPI -->
    <div
      class="relative rounded-3xl p-6 shadow-xl flex flex-col justify-between overflow-hidden bg-linear-to-r from-blue-400 to-cyan-300"
    >
  ...
  <section class="grid grid-cols-1 xl:grid-cols-2 gap-8 pb-12">
    ...
    <div class="bg-white rounded-3xl shadow-sm overflow-hidden border-2 border-emerald-200">
    ...
    <!-- Flux inventaire -->
    <div class="bg-white rounded-3xl shadow-sm overflow-hidden border-2 border-yellow-200">
      <div class="px-8 py-6 bg-white border-b border-slate-100 flex items-center justify-between">
        <div class="flex items-center gap-3">
